public class CPU
{
    ...
    public double Speed { get; set; } // В GHz
...
class Program
{
    ...
    {
        CPU cpu = new CPU { Name = "AMD Ryzen 7 5700X", Speed = 3.4, TDP = 65 };
        Motherboard motherboard = new Motherboard { Model = "MSI MORTAR WIFI", SocketType = "AM4", Chipset = "X570" };
        ...
        GPU gpu = new GPU { Brand = "NVIDIA", Name = "RTX 4070TI", Memory = 12, CoreClock = 2310 };
